...
import MedicationRequest, { RequestPriority, RequestStatus } from '#models/medication_request'
...
export default class MedicationRequestDto extends BaseModelDto {
  ...
  constructor(medicationRequest?: MedicationRequest) {
    ...
    this.department! =
      medicationRequest.department! && new DepartmentDto(medicationRequest.department!)
    this.requestedBy! =
      medicationRequest.requestedBy! && new UserDto(medicationRequest.requestedBy!)
    ...
    this.dispensation! =
      medicationRequest.dispensation! && new DispensationDto(medicationRequest.dispensation!)
  }
}
